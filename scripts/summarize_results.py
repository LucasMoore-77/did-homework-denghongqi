...
'R2':('通过',f"300次随机企业标签模拟，均值{m['R2_bare']['mean']:.6f}，95%经验范围[{m['R2_bare']['q025']:.5f},{m['R2_bare']['q975']:.5f}]，超过真实系数的次数0。初版直接尾部率为0；Skill修订后加一平滑比例0.003322，单侧95%上界0.009936。此项只通过随机标签诊断。"),
